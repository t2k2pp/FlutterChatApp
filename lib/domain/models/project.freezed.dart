...
mixin _$Project {
  ...
  String get customInstruction =>
      throw _privateConstructorUsedError; // 特定のペルソナまたは指示
  String get knowledge => throw _privateConstructorUsedError; // 蓄積された知識コンテキスト
...
// 蓄積された知識コンテキスト
  ...
  @override
  String toString() {
    return 'Project(id: $id, name: $name, description: $description, customInstruction: $customInstruction, knowledge: $knowledge, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description,
      customInstruction, knowledge, updatedAt);
...
abstract class _Project implements Project {
  const factory _Project(
      ...
      required final String knowledge,
  ...
  @override
  String get customInstruction; // 特定のペルソナまたは指示
  @override
  String get knowledge; // 蓄積された知識コンテキスト
  @override
  int get updatedAt;
